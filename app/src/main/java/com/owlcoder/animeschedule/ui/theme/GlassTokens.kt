...
object GlassTokens {
    ...
    val neutralFillLight = Color.White.copy(alpha = 0.54f)
    val neutralFillDark = Color(0xFF2C2C2E).copy(alpha = 0.70f)
    val selectedFillLight = Color.White.copy(alpha = 0.72f)
    val selectedFillDark = Color(0xFF3A3A3C).copy(alpha = 0.74f)
    val interactiveFillLight = Color.White.copy(alpha = 0.62f)
    val interactiveFillDark = Color(0xFF2C2C2E).copy(alpha = 0.78f)
